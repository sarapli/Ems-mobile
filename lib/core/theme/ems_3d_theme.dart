...
class EMS3DTheme {
  ...
  static ColorScheme _scheme(Brightness brightness) {
    return ColorScheme(
      ...
      background: brightness == Brightness.light ? emsSurface : emsNavy,
      ...
      surfaceVariant: brightness == Brightness.light ? const Color(0xFFE5ECFF) : const Color(0xFF2A3B57),
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        ...
        shadowColor: WidgetStatePropertyAll(emsBlue.withOpacity(0.35)),
    ...
    cardTheme: CardThemeData(
      color: Colors.white,
      elevation: 10,
      shadowColor: emsBlue.withOpacity(0.15),
