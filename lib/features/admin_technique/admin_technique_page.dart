...
class AdminTechniquePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Sidebar items from previous grid features
    final sidebarItems = <_SidebarEntry>[
      _SidebarEntry(_SidebarIcon(icon: Icons.admin_panel_settings_outlined, color: const Color(0xFF2E5BFF)), 'Droits d’accès'),
      _SidebarEntry(_SidebarIcon(icon: Icons.storage_outlined, color: const Color(0xFF23A566)), 'Synchronisation IPS.POST'),
      _SidebarEntry(_SidebarIcon(icon: Icons.analytics_outlined, color: const Color(0xFF7A5AF8)), 'Outil d’analyse'),
      _SidebarEntry(_SidebarIcon(icon: Icons.settings_suggest_outlined, color: const Color(0xFFFF6B35)), 'Paramètres système'),
    ];
