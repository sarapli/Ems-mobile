...
class ReceptionDepechesPage extends StatefulWidget {
  const ReceptionDepechesPage({super.key});
  static const String routePath = '/agent_guichet/reception_depeches';

  @override
  State<ReceptionDepechesPage> createState() => _ReceptionDepechesPageState();
}

class _ReceptionDepechesPageState extends State<ReceptionDepechesPage> {
  ...
  Widget build(BuildContext context) {
    return EMS3DScaffold(
      title: '',
      currentRoute: ReceptionDepechesPage.routePath,
      backgroundColor: Colors.white,
      titleWidget: const _Title(icon: Icons.inbox_outlined, text: 'Réception des dépêches'),
      body: Padding(
              ...
              child: Column(
                ...
                children: [
                  _sectionCard(children: [
                    const _SectionHeader(icon: Icons.rule_folder_outlined, title: 'Informations de réception'),
                    ...
                    LayoutBuilder(builder: (context, c) {
                      ...
                      return GridView.count(
                        ...
                        children: [
                          ...
                          _field('Bureau de réception', DropdownButtonFormField<String>(
                            value: _bureau,
                    ...
                    const SizedBox(height: 12),
                    Row(children: [
                      ElevatedButton.icon(onPressed: () {}, icon: const Icon(Icons.download_done_outlined), label: const Text('Confirmer réception')),
