...
class AdminFonctionnelPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sidebarItems = <_SidebarEntry>[
      _SidebarEntry(_SidebarIcon(icon: Icons.rule_folder_outlined, color: const Color(0xFF2E5BFF)), 'Règles Métier'),
      _SidebarEntry(_SidebarIcon(icon: Icons.description_outlined, color: const Color(0xFF7A5AF8)), 'Modèles de documents'),
      _SidebarEntry(_SidebarIcon(icon: Icons.tune_outlined, color: const Color(0xFF23A566)), 'Paramétrage fonctionnel'),
      _SidebarEntry(_SidebarIcon(icon: Icons.school_outlined, color: const Color(0xFFFF6B35)), 'Guides & Formations'),
    ];
