...
class CommercialPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Sidebar items from previous grid
    final sidebarItems = <_SidebarEntry>[
      _SidebarEntry(_SidebarIcon(icon: Icons.request_quote_outlined, color: Color(0xFF2E5BFF)), 'Devis (Pro forma)'),
      _SidebarEntry(_SidebarIcon(icon: Icons.groups_outlined, color: Color(0xFF23A566)), 'Clients & abonnements'),
      _SidebarEntry(_SidebarIcon(icon: Icons.campaign_outlined, color: Color(0xFF7A5AF8)), 'Campagnes commerciales'),
      _SidebarEntry(_SidebarIcon(icon: Icons.trending_up_outlined, color: Color(0xFFFF6B35)), 'Statistiques commerciales'),
      _SidebarEntry(_SidebarIcon(icon: Icons.description_outlined, color: Color(0xFF7A5AF8)), 'Rapports'),
      _SidebarEntry(_SidebarIcon(icon: Icons.support_agent_outlined, color: Color(0xFF23A566)), 'Assistance & support'),
    ];
