...
class ComptabilitePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Sidebar items from previous grid content
    final sidebarItems = <_SidebarEntry>[
      _SidebarEntry(_SidebarIcon(icon: Icons.receipt_long_outlined, color: Color(0xFF2E5BFF)), 'Facturation'),
      _SidebarEntry(_SidebarIcon(icon: Icons.attach_money_outlined, color: Color(0xFF00C851)), 'Encaissements'),
      _SidebarEntry(_SidebarIcon(icon: Icons.money_off_csred_outlined, color: Color(0xFFFF6B35)), 'Décaissements'),
      _SidebarEntry(_SidebarIcon(icon: Icons.list_alt_outlined, color: Color(0xFF7A5AF8)), 'Brouillard de caisse'),
      _SidebarEntry(_SidebarIcon(icon: Icons.query_stats_outlined, color: Color(0xFF2E5BFF)), 'Statistiques financières'),
      _SidebarEntry(_SidebarIcon(icon: Icons.description_outlined, color: Color(0xFF7A5AF8)), 'Rapports comptables'),
    ];
